...
export default function LogoRulesPage() {
    ...
    <div className="bg-white">
      <section id="brand-personality" className="scroll-mt-24">
        <div className="max-w-full mx-auto">
          <Image src="/brand-blueprint.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>

      <section id="logo-concept" className="scroll-mt-24">
        <div className="max-w-full mx-auto">
          <Image src="/logo-concept.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>
      ...
      <section id="layout-grid" className="relative py-8 sm:py-12 md:py-16 md:pt-32 scroll-mt-24 bg-black min-h-screen flex flex-col">
       ...
       <section id="sonic-energy" className="scroll-mt-24">
        <div className="max-w-full mx-auto">
          <Image src="/sonic-energy.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>

      

      <section id="wave-concept" className=" bg-black min-h-screen relative py-8 sm:py-12 md:py-16 scroll-mt-24">
        <div className="max-w-3xl mx-auto mt-16">
          ...
          <p className="text-white">For Soundhous, this symbolises our ability to adapt to any genre, technology,
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-12">
      ...
      <section id="brand-mark-intro" className="bg-black min-h-screen py-8 sm:py-12 md:py-16 scroll-mt-24 flex items-center justify-center">
        <div className="max-w-full mx-auto">
          <Image src="/sd-new-2.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>

      <section id="logo-variation" className="px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16 scroll-mt-24 bg-white">
        <div className="max-w-4xl mx-auto relative min-h-[800px]">
          ...
          <div className="mb-8 sm:mb-12 max-w-md">
            <p className="text-sm sm:text-base md:text-lg text-black font-sans leading-relaxed">
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
      ...
      <div className="border-l border-gray-700 pl-10 text-gray-300 text-lg leading-relaxed">
        The five (5) logo variants are not reflecting five (5)
        companies, but <span className="text-white font-semibold">ONE</span> company with
...
<section id="logo-symbols" className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto">
    ...
    <h2 className="text-2xl md:text-4xl font-bold text-black mb-12">
      <span className="font-normal mr-2">2.2.2.</span> Logo Symbols
    </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          tab. A favicon distils our brand down to its most “heroic”
          element.
        </p>
...
<section className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.2.3.</span> The Attention Logo (III)
    </h2>
...
<section id="logo-rules" className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    {/* Title */}
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.3.</span> Logo Rules
    </h2>
...
<section id="logo-clear-space" className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    {/* Title */}
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.3.1.</span> Logo Clear Space
    </h2>
  ...
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    {/* Title */}
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.3.2.</span> Layout Grid/Composition
    </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <p className="text-lg text-black">
          A consistent grid ensures that whether you are designing a mobile app or a vinyl record sleeve, our brand feels “anchored.”
        </p>
     ...
     <section id="minimum-size-format" className="w-full bg-white px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-20 lg:py-24">
  <div className="max-w-6xl mx-auto space-y-8 sm:space-y-10 md:space-y-12">
    ...
    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.3.3.</span> Minimum Size and Format
    </h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-start">
      ...
      <div className="space-y-4 sm:space-y-5 md:space-y-6 text-gray-700 leading-relaxed">
        <p className="text-sm sm:text-base md:text-lg text-black">
          Our logo must be legible in all uses. Minimum sizes are established to
          prevent illegibility due to small reproduction.
        </p>
...
<section id="logo-misuse" className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    {/* Title */}
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.3.4.</span> Logo Misuse
    </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
      ...
      <div className="space-y-4 text-gray-700 leading-relaxed">
        <p className="text-lg text-black">
          To maintain the integrity of the Soundhous brand, the logo must never be used in the following ways:
        </p>
...
<section id="co-branding" className="w-full bg-white px-6 md:px-12 py-16 md:py-24">
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    {/* Title */}
    <h2 className="text-2xl md:text-4xl font-bold text-black">
      <span className="font-normal mr-2">2.4.</span> Co-branding
    </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
      ...
      <div className="space-y-4 text-gray-700 leading-relaxed">
        ...
        <p><strong className="text-black">Equal Prominence:</strong> Both the Soundhous logo and the Partner logo must be displayed with comparable size and visual weight. Neither logo should dominate the other.</p>

        <p><strong className="text-black">Separation Element:</strong> When space allows, use a thin vertical line (a “rule”) or a clear gap of 2X to visually separate the Soundhous logo from the associated brand or text.</p>

        <p><strong className="text-black">Approval:</strong> All co-branded materials must be submitted to the Soundhous brand team for final approval before public use.</p>
      </div>
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <p>
          <strong className="text-black">Placement:</strong> In horizontal layouts, the Soundhous logo should typically be placed on the left, followed by the partner brand. (E.g. Soundhous | Partner Name or Soundhous [2X gap] Partner Logo).
        </p>
        <p>
          In vertical layouts, the Soundhous logo should typically be placed at the bottom left of the graphic.
        </p>
...
<section id="brand-personality" className="scroll-mt-24">
        <div className="max-w-full mx-auto">
          <Image src="/co-branding-assets.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>
...
<section id="brand-personality" className="scroll-mt-24">
        <div className="max-w-full mx-auto">
          <Image src="/creative-assets.png" alt="Brand Architype" width={1000} height={1000} className="w-full h-auto" />
        </div>
      </section>
