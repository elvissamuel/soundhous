  ...
  return (
    <div className="bg-white">
      ...
      >
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
            5.5&nbsp;&nbsp;AFROMIDI Sensory Exploration
          </h2>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* INTERIOR SPACES (Spans 2 columns) */}
            <div className="bg-gray-200 p-8 lg:col-span-2">
              <h3 className="tracking-[0.4em] text-center text-lg font-medium mb-4">
                INTERIOR SPACES
              </h3>
            </div>

            {/* SMELL + SOUND (Right Tall Box) */}
            <div className="bg-gray-200 p-8 lg:row-span-2 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-semibold mb-4">Smell</h3>
                ...
                <h3 className="text-xl font-semibold mt-6 mb-2">Sound</h3>
            ...
            <div className="bg-gray-200 p-8">
              <h3 className="text-xl font-semibold mb-4">Touch</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-200 p-8">
              ...
              <p className="text-sm leading-relaxed mb-6">
                ...
                <strong>Vibe:</strong>   Mysterious, powerful,  Mysterious, powerful,and exclusive.
              </p>
            ...
            <div className="bg-gray-200 p-8">
              <h3 className="text-xl font-semibold mb-4">Appearance</h3>
              <p className="text-sm leading-relaxed mb-6">
                <strong>Colours:</strong> Monochromatic
blacks, charcoal greys, silver
accents, and rich walnut
browns<br/>
                <strong>Form:</strong> Bold, sleek silhouettes
with sharp edges and heavy,
deep-seated furniture.<br/>
